...
> 최종 업데이트: 2026-09-10 (검색 경로 통합 · 골든셋 모호성 필터 — **0.925**, 4개 카테고리 만점)
...
| 40 | 청크 오버샘플 재검토 | 🔜 | 순효과 미확인. `CHUNK_OVERSAMPLE` A/B 필요 |
| 41 | VM 용어집 네트워크 복구 | 🔜 | `catalog.joycityplay.com` 접근 차단 (curl → 000). 스냅샷으로 우회 중 |
| 42 | 40문항 골든셋 평가 | 🔜 | 카테고리당 표본 확대 — 현재 3~5문항이라 한 문항이 0.33씩 움직임 |
